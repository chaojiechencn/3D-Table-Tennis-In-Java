...
public final class Constants {
    ...
    /** 40 mm diameter. [ITTF] */
    public static final double BallR = 0.020;

    /** 2.7 g. [ITTF] */
    public static final double BallM = 0.0027;

    /** Hollow shell, so (2/3)mr², not the solid sphere's (2/5)mr². [ITTF] */
    public static final double BallI = (2.0 / 3.0) * BallM * BallR * BallR;

    public static final double BallArea = Math.PI * BallR * BallR;

    /** Standard gravity. */
    public static final double G = 9.80665;

    /** Air density at sea level, 15 degC, dry. */
    public static final double AirRho = 1.225;

    /** The factor drag and lift share: 0.5 * rho * A / m. */
    public static final double HalfRhoAOverM = 0.5 * AirRho * BallArea / BallM;

    /** Constant drag coefficient [AERO]; only SelfTest's closed-form free-fall check uses it. */
    public static final double CDrag = 0.40;
     ...
     */
    public static final double SpinDecayPerM = 1.0 / 240.0;

    /** 2.74 m. [ITTF] */
    public static final double TableLength = 2.74;

    /** 1.525 m. [ITTF] */
    public static final double TableWidth = 1.525;

    /** 0.76 m. [ITTF] The origin sits on the surface, so the floor is at y = -TableHeight. */
    public static final double TableHeight = 0.76;

    /** Collision thickness of the table top. */
    public static final double TableThick = 0.025;

    /** 15.25 cm. [ITTF] */
    public static final double NetHeight = 0.1525;

    /** 1.83 m, overhanging the table by 15.25 cm each side. [ITTF] */
    public static final double NetWidth = 1.83;

    /** Real netting is ~1 mm; thicker so a fast ball cannot tunnel between steps. */
    public static final double NetThick = 0.006;

    /** Drag coefficient [FIT]: rows are airspeed (m/s), columns spin ratio S. */
    public static final double[] DragSpeeds = { 2.5, 7.5, 12.5, 17.5 };
    public static final double[] DragSpinRatios = { 0.0, 0.3, 0.7, 0.95, 1.5, 2.0 };
    public static final double[][] DragTable = {
     ...
     */
    public static final double[] LiftSpeeds = { 2.0, 3.5, 7.5, 10.5, 13.5, 17.0 };

    /** Below the breakpoint: C_M = m*omega + c. Columns are {m, c, omega_breakpoint}. */
    public static final double[][] LiftLinear = {
            {  0.0,       0.080, 150 },
            { -1.10e-3,   0.310, 200 },
            { -8.00e-4,   0.370, 350 },
            { -6.58e-4,   0.375, 440 },
    ...
    public static final double[][] LiftQuadratic = {
     ...
     */
    public static final Material RacketMat = new Material(
     ...
     */
    public static final Material TableMat =
    ...
    public static final Material FloorMat = Material.Rigid(0.80, 0.40, 1.00, 1.00);

    /** TUNED: no standard COR exists for netting; a ball into the net drops on the near side. */
    public static final Material NetMat = Material.Rigid(0.12, 0.50, 0.55, 0.35);
    ...
    public static final double MaxFrame = 0.25;
}
