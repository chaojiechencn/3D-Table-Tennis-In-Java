 ...
 */
public record Shots(String name, String detail, Ball state, Aim.Solution solution) {
    ...
    private static Shots raw(String name, String detail, Ball s) {
    ...
    public static final Shots[] ALL = {
        ...
        raw("Into the net", "8 m/s, low and flat - the net kills it dead",
            Ball.at(new Vec3(0, 0.17, 0.95), new Vec3(0, -0.20, -8.0),
        ...
        raw("ITTF drop test", "released from 30.5 cm - should rebound to 24-26 cm",
            Ball.at(new Vec3(0, 0.305 + BALL_R, -0.70), Vec3.ZERO, Vec3.ZERO)),
    ...
    /** Look a shot up by name. Used by PhysicsTest so that reordering the menu cannot silently
