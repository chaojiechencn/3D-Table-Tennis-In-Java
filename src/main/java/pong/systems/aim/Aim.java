...
public final class Aim {
     ...
     */
    public record Solution(Ball state, Vec3 landing, double netClearance,
    ...
    public static Solution atTarget(Vec3 from, Vec3 target, double speed,
        ...
        if (range < 1e-6) {
            return new Solution(Ball.at(from, Vec3.ZERO, Vec3.ZERO), from, Double.NaN, 0, false);
        }
    ...
    private static Solution finish(Vec3 from, Vec3 heading, double speed, Vec3 spinVec,
        ...
        Ball launch = Ball.at(from, velocity(heading, speed, elev), spinVec);
        Flight f = fly(launch);
    ...
    private static double rangeAt(Vec3 from, Vec3 heading, double speed, Vec3 spinVec, double elev) {
        Flight f = fly(Ball.at(from, velocity(heading, speed, elev), spinVec));
     ...
     */
    public static Vec3 landingPoint(Ball launch) {
