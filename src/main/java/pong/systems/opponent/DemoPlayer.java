...
public final class DemoPlayer {
     ...
     */
    public Vec3 cursorFor(Ball ball, boolean mayHit, double dt) {
        sincePredict += dt;
     ...
     * World#predict}, which flies a racket-free copy, so it includes the bounce off our own
     * half -- the whole reason a prediction is needed. A ball still on the opponent's side has
     * no meeting point yet.
     */
    private Meeting meeting(Ball ball, boolean mayHit) {
