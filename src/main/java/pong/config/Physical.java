...
public final class Physical {
     ...
     * constant C_d, and PhysicsTest uses that form to check the integrator against exact
    ...
    /**
     * Where the legs stand, as an offset from the table's centre. TUNED proportions of the ITTF
     * dimensions above -- decoration, never part of the collision world.
     *
     * They live here rather than in the view because TWO views read them: the frame that draws
     * the legs, and the baked contact shadows in the floor texture. Single-sourcing them is what
     * stops the feet and their shadows drifting apart.
     */
    public static final double LEG_X = TABLE_WIDTH * 0.42;
    public static final double LEG_Z = TABLE_LENGTH * 0.40;
     ...
     *  POINT is what actually matters -- see {@link Racket}'s class comment. */
