...
import pong.assets.SurfaceMaterials;
import pong.helpers.Xform;

/**
 * A table in a quiet training hall. Collision surfaces retain the dimensions in
 * {@link Physical}; decorative proportions are TUNED multiples of those dimensions.
...
public final class CourtView {
    ...
    public static MeshView horizontal(double x0, double x1, double z0, double z1, double y,
