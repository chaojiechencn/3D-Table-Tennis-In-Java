 ...
 * pong._tests.PhysicsTest checks them far harder than a human reading a panel ever could, against
 ...
 * here too, for the charge-and-release stroke. The stroke is gone -- the racket just follows
...
public final class Hud {
    ...
    public Hud() {
        controls.setText("""
            MOUSE   move to move the racket -- swing through the ball to hit
    ...
    /** The match score, already formatted by {@code pong.Scoreboard.line()}. */
