...
import pong.game_objects.ball.Aero.Derivative;
...
public final class Integrator {
    ...
    public static Ball step(Ball s, double dt) {
     ...
     *
     * PhysicsTest uses this to integrate against a CONSTANT coefficient, which is the only case
     * with a closed-form solution to compare to. The game always uses the default.
     */
    public static Ball step(Ball s, double dt, Aero.DragModel drag) {
        ...
        return new Ball(newPos, newVel, newSpin, spinOrientation(s.orient(), w, newSpin, dt));
    }
