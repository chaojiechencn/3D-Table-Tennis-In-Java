package pong.game_objects.racket.view;
 ...
 * state; the pose it draws is decided by Racket and simply read here.
 *
...
public final class RacketView {
    ...
    public RacketView(boolean redFacingAway) {
