package pong.game_objects.racket;
 ...
 *
 * The racket is KINEMATIC. Nothing pushes it around -- a player's mouse or the opponent's
...
public final class Racket {
    ...
    /**
     * The collision shape: a disc-slab -- a flat cylinder of radius {@link Physical#BLADE_R}
     * and thickness {@link Physical#BLADE_THICK}, standing perpendicular to {@code normal}.
     *
     * A snapshot, not a live view of the racket. The contact solver asks a collider the same
    ...
    public Racket(Vec3 pos, Vec3 normal) {
        this.pos = pos;
