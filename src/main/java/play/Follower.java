 ...
 * predicting opponent using {@link physics.World#predict} is the intended replacement, not a
...
public final class Follower implements Opponent {
    ...
    public void advance(BallState ball, Paddle blade, double dt) {
        ...
        if (swinging >= 0) {
            ...
            // instantly reads as an impossible velocity when Paddle differences its pose.
