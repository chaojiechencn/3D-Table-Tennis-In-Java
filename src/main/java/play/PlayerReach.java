 ...
 * render.MouseAim}, pure ray work, knows no rules) and the blade that obeys it ({@link Stroke},
...
public final class PlayerReach {
     ...
     * the horizon. Flown rather than extrapolated, through the real paddle-free integrator
